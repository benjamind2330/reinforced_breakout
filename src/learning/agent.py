...
class score:
    ...
    def __repr__(self):
        return f"Score(percentage_broken={self.percentage_broken:.2f}, time={self.time:.2f})"
...
def train():
    ...
    while True:
        ...
        # get move
        action = agent.get_action(state_vector_old)

        # perform move and get new state
        state_new = game.step(SIM_DT, to_paddle_move(action))
